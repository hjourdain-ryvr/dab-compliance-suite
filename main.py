...
Test_Cases = [
    ...
    ("applications/launch",'{"appId": "YouTube"}', dab.applications.launch, 10000),
    ("applications/launch-with-content",'{"appId": "YouTube", "contentId": "v=jfKfPfyJRdk"}', dab.applications.launch_with_content, 10000),
    ("applications/get-state",'{"appId": "YouTube"}', dab.applications.get_state, 200),
    ("applications/exit",'{"appId": "YouTube"}', dab.applications.exit, 5000),
    ...
    ("app-telemetry/start",'{"appId": "YouTube", "durationMs": 1000}', dab.app_telemetry.start, 200),
    ("app-telemetry/stop",'{"appId": "YouTube"}', dab.app_telemetry.stop, 200),
